...
const details = () => (
  ...
  <div>
    ...
    <ul>
      <li>
        Highest position achieved - Financial Manager reporting to the Financial
        Director
      </li>
      <li>
      ...
      <li>
        Experience gained -
        <ul>
          <li>Management accounts preperation</li>
          <li>Director operational reporting</li>
          <li>
            Full Insurance function - FAIS Representative and Key Individual for
            FSP
          </li>
          <li>
    ...
    <p>Bcompt Degree - UNISA - 2005</p>
    <p>Hons Bcompt Degree - UNISA - 2006</p>
    <p>Full Stack Web Cert - Hyperion Dev - 2019</p>
    <p>
      Planning on completing Google Javascript Certification on aquiring the
      relevant experience
    </p>
  </div>
);
